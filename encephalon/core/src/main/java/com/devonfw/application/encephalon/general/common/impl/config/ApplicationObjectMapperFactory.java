package com.devonfw.application.encephalon.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the encephalon application.
 */
